          ...
          {data && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card className="border-blue-200 bg-blue-50/50">
                  ...
                  <CardContent>
                    ...
                    <p className="text-sm text-muted-foreground">
                        10進数換算: {parseInt(data.exponent, 2)}
                    </p>
                 ...
                 <Card className="border-green-200 bg-green-50/50">
                  ...
                  <CardContent>
                    <div className="text-sm font-mono font-bold text-green-600 mb-1 break-all">
                        {data.mantissa}
                    </div>
              ...
              <div className="bg-slate-100 p-4 rounded-lg font-mono text-sm md:text-base overflow-x-auto">
                  ...
                  <div>
                      (-1)<sup>{data.sign}</sup> × (1 + 0.{data.mantissa}<sub>2</sub>) × 2<sup>({parseInt(data.exponent, 2)} - 127)</sup>
                  </div>
